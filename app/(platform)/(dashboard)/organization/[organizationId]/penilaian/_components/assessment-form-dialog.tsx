...
export const AssessmentFormDialog = ({ isOpen, onClose, member, periodId, onSuccess }: AssessmentFormDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    execute({
      ...
      hardSkill1: hardSkills.hardSkill1,
      hardSkill2: hardSkills.hardSkill2,
      hardSkill3: hardSkills.hardSkill3,
      hardSkill4: hardSkills.hardSkill4,
      hardSkill5: hardSkills.hardSkill5,
      hardSkill6: hardSkills.hardSkill6,
      hardSkill7: hardSkills.hardSkill7,
      softSkill1: softSkills.softSkill1,
      softSkill2: softSkills.softSkill2,
      softSkill3: softSkills.softSkill3,
      softSkill4: softSkills.softSkill4,
      softSkill5: softSkills.softSkill5,
      softSkill6: softSkills.softSkill6,
      softSkill7: softSkills.softSkill7,
      softSkill8: softSkills.softSkill8,
      softSkill9: softSkills.softSkill9,
      softSkill10: softSkills.softSkill10,
      softSkill11: softSkills.softSkill11,
      softSkill12: softSkills.softSkill12,
    });
  };
