  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className="flex items-center justify-center flex-col">
        ...
        >
          Paseban Kawis Task management
        </div>
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
          <b>Task Management for</b>
        </h1>
        <div
          className="text-3xl md:text-6xl bg-gradient-to-r from-blue-500
                to-teal-300 text-white px-4 p-2 rounded-md pb-4"
        >
